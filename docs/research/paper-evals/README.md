...
| 2026-06-26 | [Hancock & An 2020](2020-hancock-closed-form-omega.md) | Closed-form single-factor McDonald's omega (Spearman ratio-of-sums loadings); prior-art oracle for the landed Spearman-Guttman omega | → paper (`closed-form-omega`) |
