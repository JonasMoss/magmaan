...
polychoric omega under DWLS/WLS, where thresholds, polychorics, NACOV, and fitted
weights are estimated from categorical margins.
...
data, DWLS/WLS fits, and the existing
...
population omega, plus the fit-free robust delta interval for comparison.
