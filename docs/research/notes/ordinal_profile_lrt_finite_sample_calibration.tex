...
from about 0.918 to 0.975. Misspecification-mixture inversion is not yet a
stable CI method: among 3154 attempted mixture CIs, 1201 failed, mostly because
the endpoint robust profile quadratic was not positive. Successful mixture CIs
cover near nominal, but that is a selected subset. Thus the current connected-CI
evidence supports robust-scaled inversion; the misspecification-mixture path is
still a pointwise-reference diagnostic until endpoint reference construction is
hardened.
