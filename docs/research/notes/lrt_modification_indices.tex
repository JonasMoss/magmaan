...
estimator: complete-data normal-theory ML uses \texttt{ml\_profile\_lrt}, while
...
over the polychoric NACOV; continuous LS and FIML/ML2S anchors leave
\texttt{lrt\_p\_obs} empty pending their bindings, while the plain $\Delta\chi^2$
