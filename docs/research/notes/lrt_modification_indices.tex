...
with the robust mixture. Continuous WLS stays empty: its weight is not retained
on the fit. The plain $\Delta\chi^2$ columns still report for any complete-data
estimator. \texttt{score\_tests\_lrt(fit, data)} is the
