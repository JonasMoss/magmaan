...
# Build the Oslo Psychometric Gathering reveal.js deck. Repository metrics are
# regenerated by the talk project's Quarto pre-render hook.
talk-oslo:
    just --justfile talks/oslo-psychometric-gathering-2026/justfile render

talk-oslo-preview:
    just --justfile talks/oslo-psychometric-gathering-2026/justfile preview
