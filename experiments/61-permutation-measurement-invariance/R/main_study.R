...
main_study_cells <- function() {
  ...
  # Categories are generated by an ordinal-probit projection but analysed as
  # integer codes with robust continuous-data ML; no polychorics are involved.
  base$generator[base$data_type == "categorical"] <- "ordinal_codes"
  control$generator[control$data_type == "categorical"] <- "ordinal_codes"
