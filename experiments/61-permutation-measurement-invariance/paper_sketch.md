...
The configural model is fitted internally as the reference model for the metric
...
The reported ordinary, sandwich, and permutation Wald comparisons apply to the
metric, scalar, and strict equality restrictions.
