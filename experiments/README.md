...
| 58 | [guttman-rmse-coverage](58-guttman-rmse-coverage/report.qmd) | benchmark | active | Across normal, independent-generator, and Pearson-code categorical CFA simulations, how do raw and soft-clamped configural Guttman maps compare with NTML and ULS on RMSE, coverage, failures, and timing? |
