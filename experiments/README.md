...
| 58 | [guttman-rmse-coverage](58-guttman-rmse-coverage/report.qmd) | paper-sim | active | When does the chosen raw Guttman recipe (extended_triad_ls + standardized) retain useful RMSE, coverage, and admissibility, configural and correctly restricted, relative to legacy Guttman, ML, and ULS? |
...
| 61 | [permutation-measurement-invariance](61-permutation-measurement-invariance/report.qmd) | probe | active | Can fully recomputed pivotal score or Wald label permutations calibrate continuous metric-invariance tests under heterogeneous group populations, and can a Hotelling reference change the permutation-score test? |
