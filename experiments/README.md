...
| 44 | [alpha-kc-coverage](44-alpha-kc-coverage/report.qmd) | benchmark | active | Does the Kauermann-Carroll variance-of-the-variance correction (a t reference on effective df from the influence kurtosis) fix the small-N undercoverage of the distribution-free Wald interval for Cronbach's alpha and the Pearson correlation? |
