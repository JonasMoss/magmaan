...
/* magmaan: include path patched from "f2c/f2c.h" to "f2c.h" because we vendor
   AMPL/ASL's f2c.h alongside this file under third_party/port/cport/ rather
   than relying on a system libf2c install. */
#ifdef __cplusplus
extern "C" {
#endif
#include "f2c.h"
