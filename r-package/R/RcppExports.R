...
infer_fiml_lr_test_satorra2000 <- function(fit_H1, fit_H0, gamma = "empirical", a_method = "exact", h_step = 1e-4, ud_method = "2000", convention = "magmaan", h1_reference_regularization = NULL) {
    .Call(`_magmaan_infer_fiml_lr_test_satorra2000`, fit_H1, fit_H0, gamma, a_method, h_step, ud_method, convention, h1_reference_regularization)
}
