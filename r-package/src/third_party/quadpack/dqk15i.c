// @generated by dev/vendor-cpp.sh from third_party/quadpack/dqk15i.c — DO NOT EDIT; re-run `just vendor`.
...
/* ***first executable statement  dqk15i */
    epmach = magmaan_qpk_d1mach_(&c__4);
    uflow = magmaan_qpk_d1mach_(&c__1);
...
/* Computing MIN */
	...
	d__1 = 1., d__2 = magmaan_qpk_pow_dd(&d__3, &c_b6);
