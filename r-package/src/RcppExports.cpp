...
Rcpp::List frontier_profile_lrt_parameter_gmm_fitted_weight_impl(Rcpp::List fit, int parameter, double target, Rcpp::Nullable<Rcpp::String> optimizer, Rcpp::Nullable<Rcpp::List> control, Rcpp::Nullable<Rcpp::List> bounds, double constraint_tol, int max_outer, double theta_tol, double fmin_tol);
RcppExport SEXP _magmaan_frontier_profile_lrt_parameter_gmm_fitted_weight_impl(SEXP fitSEXP, SEXP parameterSEXP, SEXP targetSEXP, SEXP optimizerSEXP, SEXP controlSEXP, SEXP boundsSEXP, SEXP constraint_tolSEXP, SEXP max_outerSEXP, SEXP theta_tolSEXP, SEXP fmin_tolSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::List >::type fit(fitSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(frontier_profile_lrt_parameter_gmm_fitted_weight_impl(fit, parameter, target, optimizer, control, bounds, constraint_tol, max_outer, theta_tol, fmin_tol));
    return rcpp_result_gen;
END_RCPP
}
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< double >::type theta_tol(theta_tolSEXP);
    Rcpp::traits::input_parameter< double >::type fmin_tol(fmin_tolSEXP);
    rcpp_result_gen = Rcpp::wrap(frontier_profile_lrt_ci_parameter_gmm_fitted_weight_impl(fit, parameter, level, lower, upper, initial_step, optimizer, control, bounds, constraint_tol, root_tol, statistic_tol, max_outer, theta_tol, fmin_tol));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_magmaan_frontier_profile_lrt_parameter_gmm_fitted_weight_impl", (DL_FUNC) &_magmaan_frontier_profile_lrt_parameter_gmm_fitted_weight_impl, 10},
