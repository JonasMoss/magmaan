# Reject toolchains that lack the C++23 features latva relies on (chiefly
...
if(CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
  if(CMAKE_CXX_COMPILER_VERSION VERSION_LESS 13.0)
    message(FATAL_ERROR
      "latva requires GCC >= 13 (have ${CMAKE_CXX_COMPILER_VERSION}). "
      "GCC 13 is the first version with usable std::expected in libstdc++.")
  endif()
elseif(CMAKE_CXX_COMPILER_ID STREQUAL "Clang")
  if(CMAKE_CXX_COMPILER_VERSION VERSION_LESS 17.0)
    message(FATAL_ERROR
      "latva requires Clang >= 17 (have ${CMAKE_CXX_COMPILER_VERSION}).")
  endif()
...
elseif(CMAKE_CXX_COMPILER_ID STREQUAL "MSVC")
  if(CMAKE_CXX_COMPILER_VERSION VERSION_LESS 19.37)
    message(FATAL_ERROR
      "latva requires MSVC >= 19.37 (have ${CMAKE_CXX_COMPILER_VERSION}).")
  endif()
else()
  message(WARNING
