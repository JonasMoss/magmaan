## ---------------------------
##
## Script name:        Pre_Simulation_Study2.R            
##
## Purpose of script:  Population and analysis models for various numbers of
##                     observed variables + data extract function.
##
##
...
##      2. Data extract function
##      3. Model-based target function
## ---------------------------
...
## -------------------------------- ##
##      14 observed variables       ##
## -------------------------------- ##
pop.model14a <- '

    # factor loadings
      Y =~ 1*y1 + 0.8*y2 + 0.7*y3 + 0.6*y4 + 0.5*y5 + 0.4*y6 + 0.3*y7 
      X =~ 1*x1 + 0.8*x2 + 0.7*x3 + 0.6*x4 + 0.5*x5 + 0.4*x6 + 0.3*x7 
...
## -------------------------------- ##
##      18 observed variables       ##
## -------------------------------- ##
pop.model18a <- '

    # factor loadings
      Y =~ 1*y1 + 0.8*y2 + 0.7*y3 + 0.6*y4 + 0.5*y5 + 0.4*y6 + 0.3*y7 + 0.3*y8 + 0.2*y9
      X =~ 1*x1 + 0.8*x2 + 0.7*x3 + 0.6*x4 + 0.5*x5 + 0.4*x6 + 0.3*x7 + 0.3*x8 + 0.2*x9
