...
classify(const partable::LatentStructure& pt,
...
inline SnllsDiagnostics diagnostics_for(const partable::LatentStructure& pt,
...
fit_snlls_bounded(partable::LatentStructure pt,
                  const model::MatrixRep& rep,
                  const SampleStats& samp,
                  Bounds bounds,
                  D discrepancy = {},
